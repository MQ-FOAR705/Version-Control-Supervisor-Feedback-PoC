...
- [aa](https://github.com/MQ-FOAR705/Version-Control-Supervisor-Feedback-PoC/tree/master/aa) is a directory which contains a few files created from aa.docx using Pandoc. aa2.txt is a modified version of aa.txt where I added an additional sentence and comment for Word. I then used Pandoc to create aa2.docx which contains the changes made in aa2.txt.
