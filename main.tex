...
To create a workflow, preferably with some kind of code to eliminate at least one manual step in the chain of action.

\subsection{Decomposition}

The process of recieving feedback from my supervisor may proceed as follows:

\begin{itemize}
    \item Receive email, or log into Microsoft office online to check comments left on my writing.
    \begin{itemize}
    \item If document sent via email, then download docx file and open it in Microsoft Office or LibreOffice.
    \item If accessed online, then download the file as a docx.
    \end{itemize}
    \item Find the comments in the document.
    \item Copy the feedback from the comments boxes
    \item 
