...
\begin{itemize}
    \item Pandoc is an easy to use program. Once it is installed, a few commands in the macOS terminal allow for quick conversions from and to multiple file types.
    \item I tested a simple procedure to create and then convert a Docx file to txt and md files respectively. The procedure was a success.
    \begin{itemize}
